...
struct FasterDecoderOptions
{
	...
	int32 max_active_ ;
	int32 min_active_ ;
	BaseFloat hash_ratio_ ;
	uint32 batch_size_ ;
	uint32 max_utt_length_ ;
	uint32 inter_sil_length_ ;

	inline FasterDecoderOptions() : beam_(16.0) , beam_delta_(0.5) , max_active_(INT_MAX) , min_active_(20) , hash_ratio_(2.0) , batch_size_(625) , max_utt_length_(2000) , inter_sil_length_(50)
	{}
